...
<h4>Диски должны быть с файловой системой NTFS и иметь название CHIAOG*** или CHIAPP***</h4>
<h4>Вместо *** должен быть номер диска, пример: CHIAOG001, CHIAOG002</h4>
<h4>Требования к машине: 2 Cores, 4GB RAM</h4>
